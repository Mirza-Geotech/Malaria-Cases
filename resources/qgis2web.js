...
map.getView().fit([10799408.253288, -217897.576822, 13384976.407118, 1186081.655275], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Number Of Malaria Cases In Year 2021,2022</h2>';
        return titleElement;
    })(),
